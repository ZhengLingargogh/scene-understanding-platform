"""NetVLAD global descriptor extraction plugin."""
...
class NetVLADFeatureExtractor(FeatureExtractor):
    """Extract NetVLAD global descriptors for all reference images in a directory."""
    ...
    def infer_dataset(
        ...
        *,
        ...
        return {
            ...
            "descriptor_dim": self._engine.descriptor_dim,
            "message": "NetVLAD feature extraction completed",
        }

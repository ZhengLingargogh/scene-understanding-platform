"""SIFT local feature extraction plugin."""
    ...
    def infer_dataset(
        ...
        *,
        ...
        for index, (record, img_path) in enumerate(zip(records, image_paths), start=1):
            ...
            _progress(index, len(image_paths), "Extracting SIFT features… {}/{}".format(index, len(image_paths)))
        ...
        return {
            ...
            "feature_type": "local_sift",
            "message": "SIFT feature extraction completed",
        }
